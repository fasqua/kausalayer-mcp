...
export class MazeApiClient {
  ...
  async gateRegister(
    ...
    return this.request('POST', `/pocket/${pocketId}/gate/register`, {
      meta_address: metaAddress,
  ...
  async gateListByPocket(
    ...
    return this.request('GET', `/pocket/${pocketId}/gate/endpoints?meta_address=${encodeURIComponent(metaAddress)}`);
  }
  ...
  async gateDelete(
    ...
    return this.request('DELETE', `/pocket/${pocketId}/gate/endpoint`, {
      meta_address: metaAddress,
      endpoint_url: endpointUrl,
    });
  }
